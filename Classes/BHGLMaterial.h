...
/** Calls the appropriate gl methods to bind the material for rendering, binding the texture to the current active texture unit. */
- (void)bind;

/** Resets texture to defaults and disabled blending. */
- (void)unbind;
