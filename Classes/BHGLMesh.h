...
/** Whether GL_DEPTH_TEST should be enabled when rendering the mesh. Default is GL_TRUE. */
@property (nonatomic, assign, getter = isDepthTestEnabled) GLboolean depthTestEnabled;

/** Which faces to cull. Must be one of GL_FRONT, GL_BACK, GL_FRONT_AND_BACK, or GL_NONE. Default is GL_BACK. */
@property (nonatomic, assign) GLenum cullFaces;
