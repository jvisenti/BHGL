...
- (void)configureProgram:(BHGLProgram *)program
{
    ...
    {
        program.normalMatrix = GLKMatrix4GetMatrix3(program.modelViewMatrix);
    }
    else
    {
        program.normalMatrix = GLKMatrix3InvertAndTranspose(GLKMatrix4GetMatrix3(program.modelViewMatrix), NULL);
    }
    
    if (self.programConfigurationBlock != nil)
    {
        self.programConfigurationBlock(self, program);
    }
}
